...
export default function ManagerPage() {
  return <ProtectedPage role="MANAGER" title="Operations team"><ManagerDashboard /><OwnerRequests /><ScheduleOperations /><AvailabilityOperations /><PatientDirectory /></ProtectedPage>;
}
