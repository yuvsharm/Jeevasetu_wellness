...
export type AppointmentRequest = {
  id: string; therapy: string; requested_therapies?: string[]; requested_therapy_names?: string[]; requested_duration_minutes?: number; family_member?: string | null; therapy_name: string; preferred_practitioner: string | null; patient_name: string; age: number; gender: string;
