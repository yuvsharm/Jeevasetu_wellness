...
export function PublicFooter() {
  return <footer className="bg-[#073d25] text-white">
    <div className="site-container grid gap-10 py-14 md:grid-cols-3">
      ...
      <div><h2 className="footer-heading">Quick links</h2><div className="mt-4 grid grid-cols-2 gap-3 text-sm text-white/75"><Link href="/about">About us</Link><Link href="/therapies">Therapies</Link><Link href="/practitioners">Practitioners</Link><Link href="/work-with-us">Work with us</Link><Link href="/packages">Packages</Link><Link href="/faq">FAQ</Link><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link></div></div>
