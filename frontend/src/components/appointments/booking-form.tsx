...
const stepFields: Array<Array<keyof AppointmentFormValues>> = [
  ...
  ["therapy", "session_preference", "preferred_date", "preferred_time", "problem_description", "pain_area", "problem_duration", "doctor_reference"],
  ["address", "city", "pin_code", "landmark", "google_map_link"],
];

const labels: Record<keyof AppointmentFormValues, string> = {
  patient_name: "Patient name", age: "Age", gender: "Gender", mobile_number: "Mobile number", alternate_mobile: "Alternate mobile", email: "Email (optional)", therapy: "Therapy", session_preference: "Session preference", preferred_date: "Preferred date", preferred_time: "Preferred time", problem_description: "Problem description", pain_area: "Pain area", problem_duration: "Duration of problem", doctor_reference: "Doctor reference (optional)", address: "Address", city: "City", pin_code: "PIN code", landmark: "Landmark", google_map_link: "Google Map link (optional)",
};

export function BookingForm() {
  const [step, setStep] = useState(0);
  const [submitted, setSubmitted] = useState<AppointmentRequest | null>(null);
  const { register, handleSubmit, getValues, setError, trigger, formState: { errors } } = useForm<AppointmentFormValues>({ defaultValues: { patient_name: "", age: 18, gender: "PREFER_NOT_TO_SAY", mobile_number: "", alternate_mobile: "", email: "", therapy: "", session_preference: "SINGLE", preferred_date: "", preferred_time: "", problem_description: "", pain_area: "", problem_duration: "", doctor_reference: "", address: "", city: "Meerut", pin_code: "", landmark: "", google_map_link: "" } });
