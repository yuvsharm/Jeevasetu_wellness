...
export function BookingForm({ initialTherapy = "" }: { initialTherapy?: string }) {
  const [step, setStep] = useState(0);
  const [submitted, setSubmitted] = useState<AppointmentRequest | null>(null);
  const { register, handleSubmit, getValues, setError, trigger, formState: { errors } } = useForm<AppointmentFormValues>({ defaultValues: { patient_name: "", age: 18, gender: "PREFER_NOT_TO_SAY", mobile_number: "", alternate_mobile: "", email: "", therapy: initialTherapy, preferred_practitioner: "", session_preference: "SINGLE", preferred_date: "", preferred_time: "", problem_description: "", pain_area: "", problem_duration: "", doctor_reference: "", address: "", city: "Meerut", pin_code: "", landmark: "", google_map_link: "" } });
